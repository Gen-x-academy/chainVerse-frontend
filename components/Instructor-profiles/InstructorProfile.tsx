...
export default function InstructorProfile({ instructor }: InstructorProfileProps) {
  ...
  if (!instructor) {
    return (
      <div className="max-w-7xl mx-auto py-10 px-4 text-center">
        ...
        <p className="text-gray-500">This instructor does not exist or has been removed.</p>
  ...
  return (
    <div className="w-full" style={{ backgroundImage: "url('/instructorProfile.png')", backgroundPosition: "top", backgroundRepeat: "no-repeat", backgroundSize: "100% auto" }}>
      <div className="max-w-7xl mx-auto py-10 px-4">
        <Link href="/instructors" className="flex items-center mb-6 text-black font-bold hover:text-blue-900">
          ...
          <div className="w-full md:w-96 md:min-w-96 md:mr-8 mb-8 md:mb-0">
            <Card className="bg-white border border-[#D9D9D9] p-5 mb-8">
              <div className="flex flex-col items-center mb-8">
                ...
                <Button variant="outline" className="w-full mt-3">View All Courses</Button>
              </div>
            </Card>
            ...
            <Card className="mb-6 bg-white border border-[#D9D9D9]">
              <CardContent className="p-4">
                ...
                <div className="flex justify-between py-2 border-b border-gray-100">
                  ...
                  <span className="font-medium">{instructor.reviews || 387}</span>
                </div>
            ...
            <Card className="bg-white border border-[#D9D9D9]">
              <CardContent className="p-4">
                ...
                <div className="flex flex-wrap gap-2 mt-2">
                  <span className="bg-purple-500 text-white text-xs py-1 px-3 rounded-full">Stellar Blockchain</span>
                  <span className="bg-purple-500 text-white text-xs py-1 px-3 rounded-full">Smart Contracts</span>
                  <span className="bg-purple-500 text-white text-xs py-1 px-3 rounded-full">Cross-Border Payments</span>
                  <span className="bg-purple-500 text-white text-xs py-1 px-3 rounded-full">Distributed Systems</span>
                  <span className="bg-purple-500 text-white text-xs py-1 px-3 rounded-full">Cryptography</span>
                </div>
              </CardContent>
            </Card>
    ...
    >
      Review
         ...
         {/* Content for Courses tab */}
            {activeTab === "courses" && ( <CoursesProfile instructor={instructor} />)}
           {/* Content for Review tab */}
            {activeTab === "review" && ( <ReviewProfile instructor={instructor} />)}
          </div>
        </div>

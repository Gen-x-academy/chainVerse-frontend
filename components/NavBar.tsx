...
const NavBar: React.FC = () => {
  ...
  return (
    <>
      {displayNavbar && (
        <header className="bg-white h-24 mx-auto  flex items-center border-b-2 border-[#F2F2F2] w-full z-50">
          <nav className="w-full  mx-auto px-4 sm:px-8 lg:px-10 flex items-center justify-between" aria-label="Main navigation">
            {/* Logo */}
            ...
            <div className="flex items-center gap-4 min-w-max">
              <span className="inline-flex items-center justify-center w-10 h-10 rounded-full bg-[#E5E5E5]">
                <ShoppingCart className="w-5 h-5 text-[#4D4D4D]" />
              </span>
